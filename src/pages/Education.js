    ...
    <VerticalTimeline lineColor="#fff">
     ...
     <VerticalTimelineElement
        ...
        >
          ...
          <img src={ require('../images/certificate2.jpg')} alt="Certificate from JavaRush" />
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          date="2021"
        ...
        >
          ...
          <img src={ require('../images/java-sertificate.png')} alt="Certificate from JavaRush" />
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          date="2022"
        ...
        >
          ...
          <img src={ require('../images/certificate3.jpg')} alt="Certificate from Agile software development" />
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          date="2023"
        ...
        >
          ...
          <p>Docker</p>
          <img src={ require('../images/docker-certificate.png')}  alt="Certificate Docker" />
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          date="2023"
        ...
        >
          ...
          <img src={ require('../images/awsi.jpeg')} alt="Certificate AWS Developer Associate" />
        </VerticalTimelineElement>
      </VerticalTimeline>
  );
}
